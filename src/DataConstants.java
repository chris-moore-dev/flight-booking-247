...
public abstract class DataConstants {
    /**
     * Make sure to use right file path
     */
    ...
    protected static final String HOTELS_CLOSEST_AIRPORT = "closestAirportCode";
    ...
    protected static final String REVIEWS_USER = "user";
