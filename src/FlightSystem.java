...
public class FlightSystem {
  ...
  public void manageAccount() {
    ...
    switch (mainSelect) {
      case 1:
        viewTickets(registeredUser);
        break;
      case 2:
        viewReservations(registeredUser);
        break;
      case 3:
        viewPreferences(registeredUser);
        break;
      case 4:
        viewLinkedPeople(registeredUser);
        break;
      case 5:
        break;
      default:
  ...
  public void viewTickets(RegisteredUser user) {
    ...
    if (tickets.size() == 0) {
      System.out
          .println("You don't have any tickets yet. You can book some through 'Search Flights' in the main menu.\n");
    } else {
      System.out.println("");
      ...
      switch (select) {
        case 1:
          user.unBookFlight(tickets.get(view - 1));
  ...
  public void viewReservations(RegisteredUser user) {
    ...
    if (reservations.size() == 0) {
      System.out.println(
          "You don't have any hotel reservations yet. You can book some through 'Search Hotels' in the main menu.\n");
    } else {
      ...
      switch (select) {
        case 1:
          user.unBookHotel(reservations.get(view - 1));
  ...
  public void viewPreferences(RegisteredUser user) {
    ...
    switch (select) {
      case 1:
        System.out.println(
            "Do you have a disability or other medical condition which you would like airlines and hotels to accomodate? (y/n):");
        String medical = scanner.nextLine();
        switch (medical) {
          case "y":
            user.setMedicalCondition(true);
            break;
          case "n":
        ...
        break;
      case 2:
        System.out.println("Please set your preferred airport (Use three-letter code, ex. LAX):");
        ...
        break;
      case 3:
        System.out.println("Please add a blacklisted airport (Use three-letter code, ex. LAX):");
  ...
  public void viewLinkedPeople(RegisteredUser user) {
    ...
    switch (select) {
      case 1:
        System.out.println("----- Linked People -----\n");
  ...
  private Hotel hotelSearchHelper(String city, User user) {
    ...
    if (chooseFrom.isEmpty()) {
      System.out.println("No hotels found. Please try again.");
      return null;
    }
    for (int i = 0; i < chooseFrom.size(); i++) {
   ...
   */
  public String verifyDateString(boolean isDepart) {
    String date = scanner.nextLine();
    // Make sure depart date is in correct format
    while (!date.matches("\\d{2}/\\d{2}/\\d{4}")) {
      System.out.println("Invalid date format. Please try again.");
      System.out.println("When would you like to " + (isDepart ? "depart" : "return") + "? (MM/DD/YYYY)");
      // System.out.print("When would you like to leave? (Enter date in format of
      // MM/DD/YYYY): ");
  ...
  public void searchForFlights() {
    ...
    String departDateStr = verifyDateString(true);
    ...
    switch (flightType) {
      ...
      case 2:
        ...
        String returnDateStr = verifyDateString(false);
   ...
   * @param size          Size of flights to be booked. Used to determine how many
   *                      flights each passenger will have
  ...
  public void makeFlight() {
    ...
    Flight toAdd = new Flight(date, departingAirport, destAirport, takeOffTime, landingTime, totalFlightTime, layover,
        addThis, 2, 0.8, company);

    // Flight toAdd = new Flight(date, departingAirport, destAirport, takeOffTime,
    // landingTime, totalFlightTime, layover, company, pricing, seats,
    // departingGate, destGate);
